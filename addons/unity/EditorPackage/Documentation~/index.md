...
4. `Open in ChunkyMonkey`: opens the local ChunkyMonkey app if it is installed on `PATH`; otherwise it opens the download page.

The extension does not bundle ChunkyMonkey desktop and does not auto-launch external apps.
